# modified based on step6_wind_cohesion_perturbation.sh
# a deterministic run with cohesion=30kpa, airdrag=0.0055, no perturbation
#!/bin/bash
...
########################## changes  #########################################
Output_dir=/neXtSIM_test11_22_winter_step7_deterministic_NoPerturbation
