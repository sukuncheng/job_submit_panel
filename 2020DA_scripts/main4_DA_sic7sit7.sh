...
#SBATCH --output=sic7sit7_slurm%j.log         # Stdout
#SBATCH --error=sic7sit7_slurm%j.log          # Stderr
# ======================================================
...
mv ${JOB_SETUP_DIR}/sic7sit7_slurm%j.log  ${OUTPUT_DIR}
echo "finished"