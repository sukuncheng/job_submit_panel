...
dates = [2018-11-11 2018-11-18 2018-11-25 2018-12-02];
Ne = 20;
outputpath='/cluster/work/users/chengsukun/src/IO_nextsim/test_26_06_Ne20_T4_D7';
%it = 1;
%cd [ outputpath '/' dates(it) '/mem' num2str(ie,'%03d') ];
