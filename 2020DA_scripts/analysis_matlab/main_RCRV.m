...
%     mnt_dir = '/Users/sukeng/Desktop/fram';
    ...
    for i = 1:length(Ln)
        [b(i), d(i)] = fun_get_RCRV_statistics([ mnt_dir run_dir '/size40_I1_L' num2str(Ln(i)) '_R2_K2'])
    end

    % using 100 members
    [b100, d100] = fun_get_RCRV_statistics([ mnt_dir run_dir '/size100_I1_L300_R2_K2'])
