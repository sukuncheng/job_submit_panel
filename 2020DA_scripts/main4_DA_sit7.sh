...
Exp_ID=$SLURM_JOB_NAME     # sit7,sic7sit7
DA_VAR=sit                 # sit, sicsit
...
mv ${JOB_SETUP_DIR}/sit7_slurm%j.log  ${OUTPUT_DIR}
echo "finished"